...
- [x] Timing check: measured in production 14/8/2026 — **60.2s** for a full turn (7 LLM calls, all four modules, live AeroDataBox + Overpass + Pinecone), 7.0s for a follow-up, 2.1s for the refinement gate. Well inside the 300s limit.
